...
public class KsDto
{
    ...
    /// </summary>
    public string JockeyNameKana { get; set; } = string.Empty;
    ...
    /// </summary>
    public string JockeyNameEng { get; set; } = string.Empty;
    ...
    /// </summary>
    public string ApprenticeCode { get; set; } = string.Empty;
    ...
    /// 繰返し2回
    /// </summary>
    public List<KsFirstRideDto> FirstRideInfo { get; set; } = new();
    ...
    /// 繰返し2回
    /// </summary>
    public List<KsFirstWinDto> FirstWinInfo { get; set; } = new();
    ...
    /// 繰返し3回
    /// </summary>
    public List<KsRecentGradeWinDto> RecentGradeWinInfo { get; set; } = new();

    /// <summary>
    /// 本年･前年･累計成績情報 (1016, 3156)
    /// 現役騎手については本年・前年・累計の順に設定
    /// 引退騎手については引退年、引退前年・累計の順に設定
    /// 繰返し3回
    /// </summary>
    public List<KsPerformanceDto> PerformanceInfo { get; set; } = new();
}

/// <summary>
/// 初騎乗情報
/// </summary>
public class KsFirstRideDto
{
    /// <summary>
    /// 年月日場回日R (1, 16)
    /// レース詳細のキー情報
    ...
    /// 確定着順 (65, 2)
    /// </summary>
    public int OrderOfFinish { get; set; }
...
/// 最近重賞勝利情報
/// </summary>
public class KsRecentGradeWinDto
{
    /// <summary>
    /// 年月日場回日R (1, 16)
    /// レース詳細のキー情報
